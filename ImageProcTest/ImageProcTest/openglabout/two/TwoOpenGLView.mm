...
- (void)setupProgram
{
    // Load shaders
    //
    NSString * vertexShaderPath = [[NSBundle mainBundle] pathForResource:@"TwoVertexShader"
                                                                  ofType:@"glsl"];
    NSString * fragmentShaderPath = [[NSBundle mainBundle] pathForResource:@"TwoFragmentShader"
                                                                    ofType:@"glsl"];
...
- (void)loadTexture2:(CVPixelBufferRef)pixelBuffer2
{
