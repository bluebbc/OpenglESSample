...
@implementation CircleOpenGLView
...
- (void)setupProgram
{
    // Load shaders
    //
    NSString * vertexShaderPath = [[NSBundle mainBundle] pathForResource:@"CircleVertexShader"
                                                                  ofType:@"glsl"];
    NSString * fragmentShaderPath = [[NSBundle mainBundle] pathForResource:@"CircleFragmentShader"
                                                                    ofType:@"glsl"];
